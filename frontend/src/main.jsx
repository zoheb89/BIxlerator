...
function Sidebar({view,nav}){
 ...
 return <aside className="sidebar">
  <div className="brand"><img src="/blxlerator-logo-dark.png"/><div><strong>Blxlerator</strong><small>by Capgemini</small></div></div>
...
function Topbar(){return <header className="topbar"><div className="crumb">Blxlerator <span>/</span> Enterprise Migration Studio</div><div className="top-right"><span className="pill">DATA & AI</span><span>◔</span><span>?</span><span className="avatar">Z</span><span>Zoheb⌄</span></div></header>}
...
function PageTitle({title,sub}){return <div className="page-title"><div><div className="eyebrow dark">BLXLERATOR</div><h1>{title}</h1><p>{sub}</p></div></div>}
